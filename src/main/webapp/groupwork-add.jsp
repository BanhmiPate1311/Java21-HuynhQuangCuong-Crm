...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <c:set var="actionUrl" value="${isEdit == true ? '/groupwork/edit' : '/groupwork/add'}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="start_day" type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line date-custom" value="${job != null ? job.start_date : ''}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input name="end_day" type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line date-custom" value="${job != null ? job.end_date : ''}"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
    ...
    <script src="js/dateFormat.js?version=1"></script>
</body>
