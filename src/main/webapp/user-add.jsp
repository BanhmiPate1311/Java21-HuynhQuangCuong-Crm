        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">${isEdit == true ? "Cập nhật thành viên" : "Thêm mới thành viên"}</h4>
                </div>
            </div>
            <!-- /.row -->
            <!-- .row -->
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <c:set var="actionUrl" value="${isEdit == true ? '/user/edit' : '/user/add'}" />
                        <c:if test="${isEdit == true}">
                            <c:set var="actionUrl" value="${actionUrl}?id=${user.id}" />
                        </c:if>
                        ...
                        <form action="<c:url value="${actionUrl}" />" method="post" class="form-horizontal form-material">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="fullname" placeholder="Johnathan Doe" class="form-control form-control-line" value="${user != null ? user.fullname : ''}" /></div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="email" placeholder="johnathan@admin.com"
                                           ...
                                           id="example-email" value="${user != null ? user.email : ''}" ></div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Password</label>
                                <div class="col-md-12">
                                    <input name="password" type="password" placeholder="password" value="${user != null ? user.password : ''}"
                                ...
                                <div class="col-sm-12">
                                    <select name="role" class="form-control form-control-line">
                                        <c:forEach items="${listRoles}" var="role">
                                            <option value="${role.id}" ${user != null && user.roleId == role.id ? 'selected' : ''}>${role.description}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
