                    ...
                    <div class="white-box">
                        <div class="table-responsive">
                            <table class="table" id="example">
                                ...
                                <tbody>
                                <c:forEach items="${listJobs}" var="job" varStatus="status">
                                <tr>
                                    <td>${status.count}</td>
                                    <td>${job.getName()}</td>
                                    ...
                                    <td>
                                        ...
                                        <span jobid="${job.getId()}" class="btn btn-sm btn-danger btn-delete-job">Xóa</span>
...
<script src="<c:url value="/js/groupwork.js?version=1" /> "></script>
<script>
