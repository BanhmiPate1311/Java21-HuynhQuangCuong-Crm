        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">${isEdit == true ? "Cập nhật quyền" : "Thêm mới quyền"}</h4>
                </div>
            </div>
            <!-- /.row -->
            <!-- .row -->
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <c:set var="actionUrl" value="${isEdit == true ? '/role/edit' : '/role/add'}" />
                        <c:if test="${isEdit == true}">
                            <c:set var="actionUrl" value="${actionUrl}?id=${role.id}" />
                        </c:if>
                        ...
                        <form action="<c:url value="${actionUrl}"/>" method="post" class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input name="description" type="text" placeholder="Mô tả" class="form-control form-control-line" value="${role != null ? role.description : ''}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
