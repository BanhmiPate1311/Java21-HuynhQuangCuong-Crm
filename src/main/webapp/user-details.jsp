                        ...
                        <div class="user-bg"> <img width="100%" alt="user" src="<c:url value="/plugins/images/large/img1.jpg"/>" >
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="javascript:void(0)"><img src="<c:url value="/plugins/images/users/${userDetail.userAvatar}"/>"
                            ...
                            <div class="white-box">
                                <div class="col-in row">
                                    <div class="col-xs-12">
                                        ...
                                        <c:set var="percent1" value="${Math.round(countWithStatusOne * 100 / userDetail.taskDtoList.size())}" />
                            ...
                            <div class="white-box">
                                <div class="col-in row">
                                    <div class="col-xs-12">
                                        ...
                                        <c:set var="percent2" value="${Math.round(countWithStatusTwo * 100 / userDetail.taskDtoList.size())}" />
